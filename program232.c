...
int AtLeastOneLeafNode(PNODE Head)
{
  static int iCnt =0;
  ...
  if(Head != NULL)
   {
     ...
     AtLeastOneLeafNode(Head->lchild);
     AtLeastOneLeafNode(Head->rchild);
   }
return iCnt;
...
int main()
{
   ...
   printf("\nNumber of Leaf Node are : %d\n",iRet1);

   iRet2 = AtLeastOneLeafNode(First);
   printf("\nNumber of At least one Node are : %d\n",iRet2);
