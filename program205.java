...
class program205
{
    public static void main(String arg[])
    {
       DBMS dobj = new DBMS();
       dobj.StartDBMS(); 
       //dobj.InsertData("Aish",1000);
       /*dobj.InsertData("Tanvi",2000);
       dobj.InsertData("Sarika",3000);
       dobj.InsertData("Pari",8000);
       dobj.InsertData("Kiran",9000);
       dobj.InsertData("Abhi",10000);
      */
       
       //dobj.DisplaySpecific(3);
       //dobj.DisplaySpecific("Aish");

       //dobj.DeleteSpecific(2);
       //dobj.DeleteSpecific("Aish");
         dobj.DisplayAll();
...
class DBMS
{
  ...
  public void DisplaySpecific(int rid)
    ...
    public void AggregateMin()
       ...
       System.out.println("Information of student having minnimum salary : ");
       temp.DisplayData();  
     }
